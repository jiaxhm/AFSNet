...
class SpatialAttentionModule(BaseModule):
    ...
    def __init__(self, kernel_size=7):
        ...
        self.conv1 = Conv2d(2, 1, 7, padding=padding, bias=False)
        self.sigmoid = nn.Sigmoid()
...
class TEncoder(nn.Module):
    ...
    def __init__(self,
                 ...
                 embed_dims_list=[24, 48], # [64, 128, 256, 512]
                 feedforward_channels_list=[48, 96], #[128, 256, 512, 1024]
                 num_stages=2,
                 patch_sizes=(3, 3), # (3, 3, 3, 3, 3)
                 strides=(1, 2), # (1, 2, 2, 2, 2)
                 padding=[1, 1],
                 drop_rate=0.0,
                 **kwargs,
                 ):
    ...
    def init_weights(self):
        if self.init_cfg is None:
            ...
            super(TEncoder, self).init_weights()
