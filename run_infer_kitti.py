...
parser.add_argument('--data_dir', metavar='DIR', default='F:\lyh\Multiattention-UNet\data\KITTI',help='path to images folder')#AFSNet_new_RR1_kse
...
parser.add_argument('--output', metavar='DIR', default= './albation/AFSNet_0402_kitti_noencoderpre' ,help='path to output folder')
