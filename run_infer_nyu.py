...
parser.add_argument('--data_dir', metavar='DIR', default='F:\lyh\Multiattention-UNet\data\\nyu_preprocess_tst', help='path to images folder')#AFSNet_new_RR1_kse
...
parser.add_argument('--output', metavar='DIR', default= './albation/AFSNet_0402_nyud_noencoderpre' , help='path to output folder')
