...
class Unet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        feat4 = feat4 + self.att(feat4)
        feat4 = feat4.transpose(1, 2).view(-1, 256, int(h / 16), int(w / 16))
        # feat5 = self.down5_2(feat5)  # (256, 16, 16)
        # up4 = self.up_concat4(feat3, feat4)  # (256, 32, 32)
...
model = Unet()
print(model)
summary(model, input_size=(3, 208, 208), device='cpu')
a = torch.randn(4, 3, 208, 208)
y = model(a)
print(y.size())
